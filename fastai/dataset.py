...
class ImageClassifierData(ImageData):
    ...
    def LoadDataFromPaths(cls, rootPath, batchSize=64, transformations=(None,None), trainSubFolderName='train', validationSubFolderName='valid', testSubFolderName=None, test_with_labels=False, num_workers=8):
        ...
        Returns:
            ImageClassifierData
        """
        return cls.from_paths(rootPath,bs=batchSize,tfms=transformations,trn_name=trainSubFolderName,val_name=validationSubFolderName,test_name=testSubFolderName,test_with_labels=test_with_labels,num_workers=num_workers)
